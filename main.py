...
def init_game():
    ...
    rect_x, rect_y, rect_width, rect_height, tile_size, num_cols, num_rows = map.create_map(screen, window_width, window_height)
...
def render_all(state):
    ...
    map.create_map(state['screen'], state['window_width'], state['window_height'])
...
# ---- GESTION DES ÉVÉNEMENTS & CHEAT MODE ----
...
# ---- LOGIQUE DEPLACEMENT ET COLLISIONS ----
